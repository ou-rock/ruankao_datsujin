...
<div class="content">
  ...
  <section id="today">
    ...
    <div class="split">
      <div>
        <h3>到期卡片</h3>
        {_card_list(due_cards, with_review=True, today=context.today)}
      </div>
      <div>
        <h3>最小行动</h3>
        <div class="list">
        ...
        <div class="operation-stack" aria-label="今日产物生成">
          <form class="operation-form" method="post" action="/daily/receipt">
            <input type="hidden" name="as_of" value="{escape(context.today.isoformat())}">
    ...
    <div class="split">
      <div>
        ...
        <form method="post" action="/cheko/cards" style="margin-top:10px;">
          <input type="hidden" name="next_due" value="{escape(context.today.isoformat())}">
      ...
      <div>
        <h3>最近 Cheko 卡片</h3>
        {_card_list(cheko_cards[-4:], with_review=False, today=context.today)}
      </div>
    </div>
  </section>
    ...
    <div class="split">
      <form method="post" action="/practice">
        ...
        <div class="grid">
          ...
          <label>日期
            <input type="date" name="created_on" value="{escape(context.today.isoformat())}">
          </label>
        </div>
        <label>主题
    ...
    <div class="split">
      <form method="post" action="/cards">
        ...
        <div class="grid">
          ...
          <label>下次复习
            <input type="date" name="next_due" value="{escape(context.today.isoformat())}">
          </label>
        </div>
        <label>标题
      ...
      <div>
        <h3>最近卡片</h3>
        {_card_list(cards[-8:], with_review=False, today=context.today)}
      </div>
    </div>
  </section>
  ...
  <section id="principles">
    ...
    <div class="split">
      ...
      <div>
        <h3>原则卡 ID</h3>
        {_card_list(principle_cards, with_review=False, today=context.today)}
      </div>
    </div>
  </section>
  ...
  <section id="vault">
    ...
    <div class="list">
      <div class="item">
        ...
        <div class="meta">{escape(str(context.vault_path))}</div>
      </div>
      <div class="item">
